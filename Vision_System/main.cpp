...
int main()
{
    ...
    vector<int> Color_select = Img_Processor.Select_Color(1);
    Mat process_img = Img_Processor.Target_detect_processing(img, Color_select);
